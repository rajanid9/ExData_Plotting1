...
plot(elec_consum_data$datetime,elec_consum_data$Voltage/1000,type="l",xlab="datetime", ylab="Voltage")
...
plot(elec_consum_data$datetime,elec_consum_data$Global_reactive_power,type="l",xlab="datetime", ylab="Global_reactive_power")
dev.off()
